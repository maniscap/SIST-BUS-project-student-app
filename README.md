...
<!-- HERO BANNER -->
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,12,18,24&height=220&section=header&text=📱%20SISTCAP%20STUDENT%20BUS%20APP&fontSize=36&fontColor=ffffff&animation=fadeIn&fontAlignY=38&desc=Live%20GPS%20Bus%20Radar%20%E2%80%A2%20QR%20Pass%20Scanner%20%E2%80%A2%20Sub-Second%20Telemetry&descSize=14&descAlignY=62&descColor=bae6fd" width="100%" alt="SISTCAP Student App Header" />
...
flowchart TD
    ...
    subgraph Commuter["📱 Student / Parent Mobile App (Flutter)"]
        ...
        QRScanner["🎟️ Digital QR Pass Scanner"]:::scan
...
```
┌──────────────────────────────┬──────────────────────────────┬──────────────────────────────┐
│  🗺️ LIVE BUS RADAR MAP       │  🎟️ DIGITAL QR BOARDING      │  👤 STUDENT PROFILE          │
├──────────────────────────────┼──────────────────────────────┼──────────────────────────────┤
...
<table>
  <tr>
    ...
    <td width="50%" valign="top">
      <h3>🎟️ Digital QR Boarding Pass</h3>
      <ul>
...
├── lib/
│   ├── config/
│   │   └── gps_config.dart     # ⚙️ Telemetry endpoint configuration & defaults
│   ├── screens/
│   │   ├── home_screen.dart    # 🗺️ Live Bus Radar Map & stop markers
│   │   ├── login_screen.dart   # 🔑 Student & Parent authentication
│   │   ├── profile_screen.dart # 👤 Student profile & active pass details
│   │   ├── qr_scanner_screen.dart # 🎟️ Camera QR boarding pass scanner
│   │   └── splash_screen.dart  # 🚀 Animated branded launch screen
│   ├── services/
│   │   └── gps_tracker_service.dart # 🛰️ Firebase Realtime DB GPS stream listener
│   ├── widgets/
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,12,18,24&height=100&section=footer" width="100%" alt="Footer Banner" />
